...
class InfoCallback(BaseCallback):
    """
    Custom callback for storing and plotting additional values.
    """
    ...
    def _on_step(self) -> bool:
        ...
        # Store cumulative sums for plotting
        self.metrics["reached_goal"].append(self.sum_goal)
        self.metrics["ran_into_lava"].append(self.sum_lava)
        
        if "collision" in infos:
            if infos["collision"]:
                self.sum_collisions += 1
            #self.metrics["collision"].append(self.sum_collisions)
        ...
        if "no_shield_action" in infos:
            ...
            #self.metrics["no_shield_action"].append(self.no_shield_action)
